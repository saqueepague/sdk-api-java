...
public class InfSaldoResp   {
   ...
   * @return recibo
  **/
  @ApiModelProperty(example = "                 SALDO DE CONTA                @                036200005433591                @               13/10/2018  20:24               @                 BANCO: BANCO                  @                AGENCIA: 4029                  @              CONTA: 0082348296                @           VALOR NA DATA: R$ 50,00             ", required = true, value = "Recibo com informações do saldo. Linhas com 48 posições separadas por \"@\".")
  @NotNull
