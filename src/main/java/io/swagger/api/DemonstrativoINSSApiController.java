...
@Controller
public class DemonstrativoINSSApiController implements DemonstrativoINSSApi {

    private static final Logger log = LoggerFactory.getLogger(DemonstrativoINSSApiController.class);
    ...
    public DemonstrativoINSSApiController(ObjectMapper objectMapper, HttpServletRequest request) {
