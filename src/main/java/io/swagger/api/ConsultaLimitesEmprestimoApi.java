...
public interface ConsultaLimitesEmprestimoApi {
    ...
    @ApiOperation(value = "", nickname = "consultaLimitesEmprestimoPost", notes = "Operação de consulta dos limites disponíveis para empréstimo.", response = ConsultaLimitesEmprestimoResp.class, tags={  })
    @ApiResponses(value = { 
