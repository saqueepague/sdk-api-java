...
@Api(value = "consultaComprovantes", description = "the consultaComprovantes API")
public interface ConsultaComprovantesApi {

    @ApiOperation(value = "", nickname = "consultaComprovantesPost", notes = "Operação de consulta de pagamentos já efetuados.", response = ConsultaComprovantesResp.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Retorno com sucesso.", response = ConsultaComprovantesResp.class) })
    @RequestMapping(value = "/consultaComprovantes",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<ConsultaComprovantesResp> consultaComprovantesPost(@ApiParam(value = "Tipo de autenticação requerida." ,required=true) @RequestHeader(value="authenticationType", required=true) String authenticationType,@ApiParam(value = "Identificação do cliente." ,required=true) @RequestHeader(value="clientId", required=true) String clientId,@ApiParam(value = "Chave para validação do acesso ao serviço." ,required=true) @RequestHeader(value="token", required=true) String token);
