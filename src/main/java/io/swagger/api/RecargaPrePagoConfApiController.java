...
@Controller
public class RecargaPrePagoConfApiController implements RecargaPrePagoConfApi {

    private static final Logger log = LoggerFactory.getLogger(RecargaPrePagoConfApiController.class);
    ...
    public RecargaPrePagoConfApiController(ObjectMapper objectMapper, HttpServletRequest request) {
