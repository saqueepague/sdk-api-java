...
@Controller
public class ConsultaComprovantesApiController implements ConsultaComprovantesApi {

    private static final Logger log = LoggerFactory.getLogger(ConsultaComprovantesApiController.class);
