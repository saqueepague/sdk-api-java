...
@Api(value = "demonstrativoINSSConf", description = "the demonstrativoINSSConf API")
public interface DemonstrativoINSSConfApi {

    @ApiOperation(value = "", nickname = "demonstrativoINSSConfPost", notes = "Confirmação de operação de demonstrativo INSS.", tags={  })
    @ApiResponses(value = { 
