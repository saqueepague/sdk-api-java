...
@Controller
public class DemonstrativoINSSConfApiController implements DemonstrativoINSSConfApi {

    private static final Logger log = LoggerFactory.getLogger(DemonstrativoINSSConfApiController.class);
    ...
    public DemonstrativoINSSConfApiController(ObjectMapper objectMapper, HttpServletRequest request) {
