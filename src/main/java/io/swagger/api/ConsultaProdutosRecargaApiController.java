...
public class ConsultaProdutosRecargaApiController implements ConsultaProdutosRecargaApi {
    ...
    public ResponseEntity<ConsultaProdutosRecargaResp> consultaProdutosRecargaPost(@ApiParam(value = "Tipo de autenticação requerida." ,required=true) @RequestHeader(value="authenticationType", required=true) String authenticationType,@ApiParam(value = "Identificação do cliente." ,required=true) @RequestHeader(value="clientId", required=true) String clientId,@ApiParam(value = "Chave para validação do acesso ao serviço." ,required=true) @RequestHeader(value="token", required=true) String token,@ApiParam(value = "Requisição de consulta produtos de recarga disponíveis para um cartão." ,required=true )  @Valid @RequestBody ConsultaProdutosRecargaReq body) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<ConsultaProdutosRecargaResp>(objectMapper.readValue("{  \"InfTransacao\" : {    \"cdProc\" : \"029100\",    \"mensagemCliente\" : \"Não foi possível validar o cartão.\",    \"nsu\" : \"000080247206\",    \"codMoeda\" : \"986\",    \"codOperadora\" : \"00000000914\",    \"dataLocal\" : \"1122\",    \"errorMessage\" : \"Cartão inválido.\",    \"valor\" : \"5000\",    \"horaLocal\" : \"151032\",    \"nsuResposta\" : \"820\",    \"dataHora\" : \"1122151032\"  },  \"InfConsultaProdutosRecarga\" : {    \"products\" : [ {      \"name\" : \"Produto de Recarga\",      \"id\" : \"1\"    }, {      \"name\" : \"Produto de Recarga\",      \"id\" : \"1\"    } ]  },  \"Terminal\" : {    \"codEstab\" : \"000000000742673\",    \"tipo\" : \"008\",    \"id\" : \"05100004\"  }}", ConsultaProdutosRecargaResp.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
                return new ResponseEntity<ConsultaProdutosRecargaResp>(HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }
