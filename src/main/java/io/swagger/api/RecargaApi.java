...
public interface RecargaApi {
    ...
    @ApiOperation(value = "", nickname = "recargaPost", notes = "Operação de recarga.", response = RecargaResp.class, tags={  })
    @ApiResponses(value = { 
