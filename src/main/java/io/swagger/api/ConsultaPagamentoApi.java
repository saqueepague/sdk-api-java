...
public interface ConsultaPagamentoApi {
    ...
    @ApiOperation(value = "", nickname = "consultaPagamentoPost", notes = "Operação de consulta de pagamentos para verificar se as informações são válidas pela CIP.", response = ConsultaPagamentoResp.class, tags={  })
    @ApiResponses(value = { 
