...
@Controller
public class ConsultaPrePagoApiController implements ConsultaPrePagoApi {

    private static final Logger log = LoggerFactory.getLogger(ConsultaPrePagoApiController.class);
    ...
    public ConsultaPrePagoApiController(ObjectMapper objectMapper, HttpServletRequest request) {
