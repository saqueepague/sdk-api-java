...
public class ConsultaValoresRecargaApiController implements ConsultaValoresRecargaApi {
    ...
    public ResponseEntity<ConsultaValoresRecargaResp> consultaValoresRecargaPost(@ApiParam(value = "Requisição de consulta valores de recarga." ,required=true )  @Valid @RequestBody ConsultaValoresRecargaReq body,@ApiParam(value = "Tipo de autenticação requerida." ,required=true) @RequestHeader(value="authenticationType", required=true) String authenticationType,@ApiParam(value = "Identificação do cliente." ,required=true) @RequestHeader(value="clientId", required=true) String clientId,@ApiParam(value = "Chave para validação do acesso ao serviço." ,required=true) @RequestHeader(value="token", required=true) String token) {
