...
@Controller
public class ConsultaComprovantePagamentoApiController implements ConsultaComprovantePagamentoApi {

    private static final Logger log = LoggerFactory.getLogger(ConsultaComprovantePagamentoApiController.class);
