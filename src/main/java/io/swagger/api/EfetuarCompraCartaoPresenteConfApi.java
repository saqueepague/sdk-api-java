...
@Api(value = "efetuarCompraCartaoPresenteConf", description = "the efetuarCompraCartaoPresenteConf API")
public interface EfetuarCompraCartaoPresenteConfApi {

    @ApiOperation(value = "", nickname = "efetuarCompraCartaoPresenteConfPost", notes = "Confirmação de operação de compra de Cartão presente.", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/efetuarCompraCartaoPresenteConf",
