...
@Controller
public class TransferenciaConfApiController implements TransferenciaConfApi {

    private static final Logger log = LoggerFactory.getLogger(TransferenciaConfApiController.class);
    ...
    public TransferenciaConfApiController(ObjectMapper objectMapper, HttpServletRequest request) {
